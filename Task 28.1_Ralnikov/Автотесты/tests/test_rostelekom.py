...
# Для запуска кода раскомментить код: python -m pytest -v --driver Chrome --driver-path /tests/chromedriver.exe tests/test_rostelekom.py

# ТК-РТ-001
# Логотип Ростелеком - переход на форму авторизации
...
# ТК-РТ-011
# Заполнение формы "Регистрация" c невалидной электронной почтой
...
# ТК-РТ-012
# Заполнение формы "Регистрация" c невалидным номером телефона (на 1 цифру больше)
...
# ТК-РТ-013
# Заполнение формы "Регистрация" c невалидным номером телефона (на 1 цифру меньше)
...
# ТК-РТ-018
# Кнопка "VK" кликабельна и открывает форму для регистрации через аккаунт ВКонтакте
...
# ТК-РТ-019
# Кнопка "OK" кликабельна и открывает форму для регистрации через аккаунт Одноклассники
...
# ТК-РТ-020
# Кнопка "@" ("Мой мир") кликабельна и открывает форму для регистрации через аккаунт Электронной почты
